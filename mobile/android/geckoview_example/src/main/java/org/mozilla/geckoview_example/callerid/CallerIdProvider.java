...
public class CallerIdProvider extends ContentProvider {
    ...
    public static final String AUTH = "org.mozilla.geckoview_example.callerid";
    ...
    public Bundle call(String method, @Nullable String arg, @Nullable Bundle extras) {
        ...
        try {
            String purpose = (extras != null ? extras.getString(EXTRA_PURPOSE, "customtab") : "customtab");
            int uid = Binder.getCallingUid();
            PackageManager pm = getContext().getPackageManager();
            String packageName = pm.getNameForUid(uid);

            Log.d(LOGTAG, "Issuing nonce for purpose: " + purpose + ", uid: " + uid + ", package: " + packageName);
            String nonce = CallerNonceStore.issue(purpose, uid, packageName);
